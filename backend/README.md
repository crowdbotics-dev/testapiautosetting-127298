...
## Project Structure
    ...
    ├── testapiautosetting_127298  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127298`
...
2. Clone this repo and `cd testapiautosetting_127298`
